...
_整个项目的数据刷新时间：`2026-09-15 09:51:09 北京时间`。_
...
当前仓库快照来自生成数据，检查时间：`2026-09-15 09:31:56 北京时间`。
...
| Android APK 归档 | 保留 `18` 个游戏的 `288` 条已确认或历史验证过的官方 APK CDN 记录 |
...
| 原神 / Genshin Impact | `0.9.3` -> `6.6.0` | `53` 个版本桶 / `53` 条记录 | `44` 条可用；`9` 条不可用或历史死链记录 |
