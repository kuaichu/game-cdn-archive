...
_整个项目的数据刷新时间：`2026-09-17 17:42:05 北京时间`。_
...
当前仓库快照来自生成数据，检查时间：`2026-09-17 17:25:45 北京时间`。
...
| 游戏 | 已索引版本 | 记录 | 备注 |
| --- | --- | --- | --- |
| 深空之眼 / Aether Gazer | `0.285.0` -> `0.307.210` | `7` 个版本桶 / `7` 条记录 | `1` 条可用；`6` 条不可用或历史死链记录 |
...
| 战双帕弥什 / Punishing: Gray Raven | `4.7.0` | `1` 个版本桶 / `1` 条记录 | `1` 条可用；`0` 条不可用或历史死链记录 |
