...
_整个项目的数据刷新时间：`2026-09-17 09:36:28 北京时间`。_
...
当前仓库快照来自生成数据，检查时间：`2026-09-17 09:29:31 北京时间`。
...
| Android APK 归档 | 保留 `17` 个游戏的 `289` 条已确认或历史验证过的官方 APK CDN 记录 |
...
| 少女前线2：追放 / Girls' Frontline 2: Exilium | `4.0.0` | `1` 个版本桶 / `1` 条记录 | `0` 条可用；`1` 条不可用或历史死链记录 |
