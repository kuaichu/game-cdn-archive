...
| 游戏 | 平台 | 状态 | 版本更新时间 |
| --- | --- | --- | --- |
| Neverness to Everness / 异环 | Windows PC | 已解码并索引到 `1.2.21`（可用 `49` 个 / 已探测 `84` 个） | `2026-07-30 04:00:02 北京时间` |
...
_整个项目的数据刷新时间：`2026-08-13 08:17:12 北京时间`。_
...
当前仓库快照来自生成数据，检查时间：`2026-08-13 08:00:26 北京时间`。

| 范围 | 当前进度 |
| --- | --- |
| NTE / 异环 PC | 已索引官方 Windows 清单 `1.0.0` 到 `1.2.21`；`84` 个已探测条目中有 `49` 个可用版本 |
...
| 卡拉比丘 / Calabiyau | `1.1.1.1972` -> `1.1.7.2` | `2` 个版本桶 / `2` 条记录 | `1` 条可用；`1` 条不可用或历史死链记录 |
