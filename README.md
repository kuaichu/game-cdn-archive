...
| Tower of Fantasy / 幻塔 | Windows PC | 官方 PatcherSDK ResList 已解码并索引到 `6.2.4`（`43` 个版本） | `2026-07-30 04:00:03 北京时间` |
...
_整个项目的数据刷新时间：`2026-08-11 08:14:27 北京时间`。_
...
当前仓库快照来自生成数据，检查时间：`2026-08-11 07:52:39 北京时间`。

| 范围 | 当前进度 |
| --- | --- |
| NTE / 异环 PC | 已索引官方 Windows 清单 `1.0.0` 到 `1.2.21`；`84` 个已探测条目中有 `49` 个可用版本 |
| Tower of Fantasy / 幻塔 PC | 已索引官方 Windows ResList `5.5.3` 到 `6.2.4`；最新清单包含 `91` 个完整文件与 `588` 个补丁对象 |
