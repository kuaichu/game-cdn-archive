...
| --- | --- | --- |
| Neverness to Everness / 异环 | Windows PC | Version manifests decoded and indexed through `1.2.12` (41 available / 75 probed) |
...
_Last refreshed from generated archive data: NTE `2026-07-07 01:09:36 +0000`; HoYo `2026-07-07T01:13:18.662Z`; Endfield `2026-07-07T01:15:56.782934+00:00`; Arknights `2026-07-07T01:16:17.359640+00:00`; WuWa `2026-07-07T01:16:16.218309+00:00`._
...
Current repository snapshot from generated data checked on `2026-07-07 01:09:36 +0000`:

| Area | Current progress |
| --- | --- |
| NTE / 异环 PC | Indexed official Windows manifests from `1.0.0` through `1.2.12`; 41 available versions out of 75 probed entries |
...
| Android APK archive | Preserves `213` confirmed or historically verified official APK CDN records across `15` games |
...
| --- | --- | --- | --- |
| 深空之眼 / Aether Gazer | `0.285.0` -> `0.305.3` | `5` version buckets / `5` records | `2` available; `3` unavailable or historical dead-link records |
...
| 鸣潮 / Wuthering Waves | `0.7.0` -> `3.4.1` | `31` version buckets / `31` records | `24` available; `7` unavailable or historical dead-link records |
