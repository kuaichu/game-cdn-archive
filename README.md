...
| Wuthering Waves / 鸣潮 | Windows PC | 官方启动器资源索引与 CDN 镜像已索引到 `3.5.2`（`43` 个版本） | `2026-07-14 18:20:15 北京时间` |
...
_整个项目的数据刷新时间：`2026-07-21 14:59:18 北京时间`。_
...
当前仓库快照来自生成数据，检查时间：`2026-07-21 14:40:34 北京时间`。
