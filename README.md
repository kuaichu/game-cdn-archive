...
_整个项目的数据刷新时间：`2026-09-06 16:48:52 北京时间`。_
...
当前仓库快照来自生成数据，检查时间：`2026-09-06 16:39:17 北京时间`。
...
| HoYo CN PC 目录 | 已迁移公开 HoyoFiles 元数据：原神 `1.0.0-7.0.0`（`56` 个版本），崩坏：星穹铁道 `1.0.5-4.5.0`（`30` 个版本），绝区零 `0.2.0-3.1.0`（`20` 个版本），崩坏3 `3.5.0-9.0.0`（`56` 个版本） |
