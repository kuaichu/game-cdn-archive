...
| 游戏 | 平台 | 状态 | 版本更新时间 |
| --- | --- | --- | --- |
| Neverness to Everness / 异环 | Windows PC | 已解码并索引到 `1.3.9`（可用 `56` 个 / 已探测 `103` 个） | `2026-08-20 04:00:03 北京时间` |
...
_整个项目的数据刷新时间：`2026-08-20 07:57:22 北京时间`。_
...
当前仓库快照来自生成数据，检查时间：`2026-08-20 07:40:34 北京时间`。

| 范围 | 当前进度 |
| --- | --- |
| NTE / 异环 PC | 已索引官方 Windows 清单 `1.0.0` 到 `1.3.9`；`103` 个已探测条目中有 `56` 个可用版本 |
...
| 卡拉比丘 / Calabiyau | `1.1.1.1972` -> `1.1.8.1` | `2` 个版本桶 / `2` 条记录 | `2` 条可用；`0` 条不可用或历史死链记录 |
