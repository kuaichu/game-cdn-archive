...
| WuWa multi-CDN adapter | partial | Structural metadata availability is done for primary `url` + `urls` candidates with no live probing. Live multi-CDN probing remains todo as the next independent step. |
