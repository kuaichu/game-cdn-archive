...
| 游戏 | 平台 | 状态 | 版本更新时间 |
| --- | --- | --- | --- |
| Neverness to Everness / 异环 | Windows PC | 已解码并索引到 `1.3.10`（可用 `57` 个 / 已探测 `104` 个） | `2026-08-21 04:00:01 北京时间` |
...
_整个项目的数据刷新时间：`2026-08-21 07:57:57 北京时间`。_
...
当前仓库快照来自生成数据，检查时间：`2026-08-21 07:42:59 北京时间`。

| 范围 | 当前进度 |
| --- | --- |
| NTE / 异环 PC | 已索引官方 Windows 清单 `1.0.0` 到 `1.3.10`；`104` 个已探测条目中有 `57` 个可用版本 |
