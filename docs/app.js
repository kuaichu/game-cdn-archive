...
const ASSET_VERSION = "20260708-p5x-pc";
...
]).then(async ([nteCatalog, tofCatalog, p5xCatalog, hoyoIndex, endfieldIndex, endfieldVersions, wuwaIndex, arknightsIndex, arknightsVersions, androidIndex, napLegacyCandidates]) => {
