...
当前仓库快照来自生成数据，检查时间：`2026-07-07 07:51:40 +0000`。
...
| 崩坏3 / Honkai Impact 3rd | `0.9.9` -> `8.9.0` | `39` 个版本桶 / `39` 条记录 | `15` 条可用；`24` 条不可用或历史死链记录 |
...
| 原神 / Genshin Impact | `0.9.3` -> `6.7.0` | `54` 个版本桶 / `54` 条记录 | `50` 条可用；`4` 条不可用或历史死链记录 |
