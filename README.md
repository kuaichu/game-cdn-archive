...
| 游戏 | 平台 | 状态 | 版本更新时间 |
| --- | --- | --- | --- |
| Neverness to Everness / 异环 | Windows PC | 已解码并索引到 `1.2.17`（可用 `45` 个 / 已探测 `80` 个） | `2026-07-23 06:00:04 北京时间` |
...
_整个项目的数据刷新时间：`2026-07-23 08:32:30 北京时间`。_
...
当前仓库快照来自生成数据，检查时间：`2026-07-23 08:14:28 北京时间`。

| 范围 | 当前进度 |
| --- | --- |
| NTE / 异环 PC | 已索引官方 Windows 清单 `1.0.0` 到 `1.2.17`；`80` 个已探测条目中有 `45` 个可用版本 |
